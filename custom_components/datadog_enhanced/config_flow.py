"""Config flow for Datadog Enhanced."""
...
class DatadogEnhancedConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Datadog Enhanced."""
        ...
        if user_input:
            ...
            if not success:
                ...
                return self.async_create_entry(
                    title=f"Datadog Enhanced {user_input['host']}",
                    data={
    ...
    def async_get_options_flow(config_entry: ConfigEntry) -> OptionsFlow:
        ...
        return DatadogEnhancedOptionsFlowHandler()


class DatadogEnhancedOptionsFlowHandler(OptionsFlow):
    """Handle Datadog Enhanced options."""

    async def async_step_init(
        self, user_input: dict[str, Any] | None = None
    ) -> ConfigFlowResult:
        """Manage the Datadog Enhanced options."""
        errors: dict[str, str] = {}
